...
namespace TagSelecta.TagTemplate
{
    public partial class TagTemplateContextMapper
    {
        ...
        public static partial global::TagSelecta.TagTemplate.TagTemplateContext Map(global::TagSelecta.Tagging.TagData tag)
        {
            var target = new global::TagSelecta.TagTemplate.TagTemplateContext();
            target.Artist = ListToString(tag.Artist);
            target.ArtistList = tag.Artist;
            target.AlbumArtist = ListToString(tag.AlbumArtist);
            target.AlbumArtistList = tag.AlbumArtist;
            target.Album = tag.Album;
            target.Title = tag.Title;
            target.Subtitle = tag.Subtitle;
            target.Genre = ListToString(tag.Genre);
            ...
            target.Bpm = tag.Bpm;
            target.Composers = ListToString(tag.Composers);
